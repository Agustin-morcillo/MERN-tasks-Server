...
const tasksController = {
    ...
    taskList: async (req, res) => { /* REVISAR ACA, EN RUTAS Y EN VALIDATOR----------------------------------------- */
    ...
    editTask: async (req, res) => {
        ...
        try {
            ...
            const editedTask = await Task.findOneAndUpdate({_id: req.params.id}, currentTask, {new: true})
    ...
    deleteTask: async (req, res) => {  /* * REVISAR ACA, EN RUTAS Y EN VALIDATOR----------------------------------------- */
